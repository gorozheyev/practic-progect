...
public class BaseClassForContact {
	...
	protected void fillContactForms(DataForContact data) {
		    ...
		    driver.findElement(By.name("byear")).sendKeys(data.yearBirth);
		    driver.findElement(By.name("address2")).clear();
		    driver.findElement(By.name("address2")).sendKeys(data.address);
		    driver.findElement(By.name("phone2")).clear();
		    driver.findElement(By.name("phone2")).sendKeys(data.house);
	}
